...
public class TelaCadastroCliente extends javax.swing.JFrame {
    ...
    public TelaCadastroCliente(TelaPrincipal telaAnterior){
        ...
        ClienteTableModel obj = new ClienteTableModel();
        model = new ClienteTableModel(obj.ConsultaBancoCliente());
        jt_cadastro_cliente.setModel(model);
        jt_cadastro_cliente.setAutoResizeMode(jt_cadastro_cliente.AUTO_RESIZE_OFF);
        
        jt_cadastro_cliente.getColumnModel().getColumn(0).setPreferredWidth(35);  
        jt_cadastro_cliente.getColumnModel().getColumn(1).setPreferredWidth(170);
        jt_cadastro_cliente.getColumnModel().getColumn(2).setPreferredWidth(60);
        jt_cadastro_cliente.getColumnModel().getColumn(3).setPreferredWidth(92);
        jt_cadastro_cliente.getColumnModel().getColumn(4).setPreferredWidth(65);
        jt_cadastro_cliente.getColumnModel().getColumn(5).setPreferredWidth(100);
        jt_cadastro_cliente.getColumnModel().getColumn(6).setPreferredWidth(118);
        jt_cadastro_cliente.getColumnModel().getColumn(7).setPreferredWidth(100);
        jt_cadastro_cliente.getColumnModel().getColumn(8).setPreferredWidth(67);
    ...
    private void initComponents() {
        ...
        setTitle("CADASTRO DE CLIENTES FISICO");
        setResizable(false);
    ...
    private void btn_salvar_clienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_salvar_clienteActionPerformed
        ...
        cliente = new Cliente(endereco, contato, nome, cpf, rg, sexo);
    ...
    private void jt_cadastro_clienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jt_cadastro_clienteMouseClicked
        ...
        if (conn != null){
            try{
                ...
                ResultSet rs = estado1.executeQuery("SELECT nome, cpf, rg FROM cliente WHERE cod = " + ClienteDAO.cod + " ");     
                Statement estado2 = conn.createStatement();
                ResultSet rs1 = estado2.executeQuery("SELECT endereco, numero, cidade, bairro, cep FROM endereco_cliente WHERE cod_cliente_c = " + ClienteDAO.cod +" ");
                Statement estado3 = conn.createStatement();
                ResultSet rs2 = estado3.executeQuery("SELECT telefone_residencial, telefone_celular, email FROM contato_cliente WHERE cod_cliente = " + ClienteDAO.cod +" ");
